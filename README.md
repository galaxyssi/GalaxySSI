...
- iOS app: `apps/ios` with Android-parity global Agent continuity, voice interaction, PCM/VAD voice capture, Local Whisper ASR foundation, Whisper model download and provider settings management, voice latency tracing, durable content-free diagnostics export, and native tool policies for iOS 15+
