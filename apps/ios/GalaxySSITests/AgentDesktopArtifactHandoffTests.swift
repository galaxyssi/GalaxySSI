...
final class AgentDesktopArtifactHandoffTests: XCTestCase {
  ...
  func testDesktopArtifactStoreReassemblesAndResolvesWithoutPrivatePathLeak() throws {
    ...
    let artifactURI = "galaxyssi-artifact://task/outputs/result.bin"
    ...
    XCTAssertTrue(resolved.uri.hasPrefix("galaxyssi-local-artifact://"))
    ...
    let encoded = """
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "type": "image",
          "title": "marked.jpg",
          "uri": "galaxyssi-artifact://task/outputs/marked.jpg",
          "data_b64": "aW1hZ2U=",
  ...
  func testRuntimeArtifactCardUsesSafeReferenceAndActions() throws {
    ...
    XCTAssertTrue(file.uri.hasPrefix("galaxyssi-runtime-artifact://"))
  ...
  private func temporaryDirectory(_ name: String) -> URL {
    let root = FileManager.default.temporaryDirectory
      .appendingPathComponent("galaxyssi-ios-tests", isDirectory: true)
