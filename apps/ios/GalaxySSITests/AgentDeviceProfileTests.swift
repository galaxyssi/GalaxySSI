...
final class AgentDeviceProfileTests: XCTestCase {
  func testLocalIdentityNameUsesDeviceNameAndIdentitySuffix() {
    XCTAssertEqual(
      GalaxySSIDeviceIdentityName.format(
        ...
        galaxySSIId: "galaxyssi:0123456789ab69d7"
      ),
  ...
  func testLocalIdentityNameNormalizesWhitespaceAndSuffixCase() {
    XCTAssertEqual(
      GalaxySSIDeviceIdentityName.format(
        ...
        galaxySSIId: "galaxyssi:0123456789abcdef"
      ),
      "Alice's iPhone · CDEF"
    )
  }
  ...
  func testLocalIdentityNameMigratesOnlyLegacyDefaults() {
    XCTAssertTrue(GalaxySSIDeviceIdentityName.isLegacyDefault("Me"))
    XCTAssertTrue(GalaxySSIDeviceIdentityName.isLegacyDefault("\u{6211}"))
    XCTAssertTrue(GalaxySSIDeviceIdentityName.isLegacyDefault("  "))
    XCTAssertFalse(GalaxySSIDeviceIdentityName.isLegacyDefault("Helen"))
  }
