...
final class GlobalResearchPromptBuilderTests: XCTestCase {
  ...
  func testSynthesisPromptIncludesLedgerQualityAndUntrustedWorkerReports() {
    ...
    researchTask.researchPlan = completedPlan(
      for: researchTask,
      result: "CLAIM: GalaxySSI iOS supports iOS 15. | SOURCE: https://developer.apple.com/documentation/swiftui | DATE: 2026-07-30"
    )
    let ledger = GlobalEvidenceLedger(
      ...
      claims: [
        GlobalEvidenceClaim(
          statement: "GalaxySSI iOS supports iOS 15.",
    ...
    XCTAssertTrue(prompt.contains("GalaxySSI iOS supports iOS 15."))
  ...
  func testLocalSynthesisUsesClaimsSourcesAndProvisionalWarning() {
    ...
    XCTAssertTrue(synthesis.contains("- GalaxySSI iOS supports iOS 15."))
