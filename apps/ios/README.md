...
- Android-style iOS Desktop Control wire models for `desktop.*` action ids, bounded screenshot streams, three-layer perception snapshots, durable task pause/takeover summaries, and identity-bound action receipt verification
