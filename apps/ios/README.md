...
- Android-style iOS Whisper model settings page with current/use/download/retry/waiting row actions, removable installed model rows, locale-aware foreground downloads, and automatic ASR model selection after validation
