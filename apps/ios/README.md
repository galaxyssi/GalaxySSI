...
- Chats and contacts backed by a local Codable store, including unread conversation summaries, local message deletion, chat history clearing, message details, and delivery trace inspection
