...
struct GalaxySSIBackupIdentity: Codable, Equatable {
  var kind: String
...
struct GalaxySSIBackupPrivacyManifest: Codable, Equatable {
  ...
  static let empty = GalaxySSIBackupPrivacyManifest(
...
struct GalaxySSIBackupAgentData: Codable, Equatable {
  ...
  var globalAgentState: GalaxySSIGlobalAgentBackupData?
  ...
  static let empty = GalaxySSIBackupAgentData(
    serverLinks: [],
    memory: nil,
  ...
  init(
    ...
    globalAgentState: GalaxySSIGlobalAgentBackupData? = nil,
  ...
  init(from decoder: Decoder) throws {
    ...
    globalAgentState = try container.decodeIfPresent(
      GalaxySSIGlobalAgentBackupData.self,
...
struct GalaxySSIBackupPayload: Codable, Equatable {
  var platform: String
  var exportedAt: Int64
  var identity: GalaxySSIBackupIdentity?
  var profile: GalaxySSIProfile
  var includesContacts: Bool
  var includesMessages: Bool
  var includesAgentData: Bool
  var privacyManifest: GalaxySSIBackupPrivacyManifest
  var agentData: GalaxySSIBackupAgentData
  ...
  init(
    platform: String = "ios",
    exportedAt: Int64 = GalaxySSIBackupManager.currentTimestampMilliseconds(),
    identity: GalaxySSIBackupIdentity?,
  ...
  init(from decoder: Decoder) throws {
    ...
    identity = try container.decodeIfPresent(GalaxySSIBackupIdentity.self, forKey: .identity)
    ...
    privacyManifest = try container.decode(GalaxySSIBackupPrivacyManifest.self, forKey: .privacyManifest)
    agentData = try container.decode(GalaxySSIBackupAgentData.self, forKey: .agentData)
...
struct GalaxySSIBackupRoot: Codable, Equatable {
  var version: Int
  var type: String
  var kdf: String
  var iterations: Int
...
enum GalaxySSIBackupManager {
  ...
  static func pbkdf2SHA256(
    ...
    guard iterations > 0, keyByteCount > 0 else {
      throw GalaxySSIError.invalidPayload("Backup KDF parameters are invalid.")
    }
  ...
  static func defaultFilename() -> String {
    "galaxyssi_backup_\(currentTimestampMilliseconds()).hcbak"
  }
  ...
  private static func randomData(count: Int) throws -> Data {
    ...
    guard status == errSecSuccess else {
      throw GalaxySSIError.invalidPayload("Unable to create secure backup randomness.")
    }
    return Data(bytes)
  }
...
struct GalaxySSIBackupDocument: FileDocument {
