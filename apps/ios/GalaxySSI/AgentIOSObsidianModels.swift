...
final class AgentIOSObsidianStateStore {
  ...
  init(
    ...
    key: String = "galaxyssi-ios-obsidian-v1"
  ) {
...
enum AgentIOSObsidianProjectionPrivacyPolicy {
  ...
  static func transcriptText(_ value: String) -> String {
    sensitive(value) ? "[Sensitive content omitted by GalaxySSI]" : value.trimmingCharacters(in: .whitespacesAndNewlines)
  }
  ...
  private static let sensitiveTerms = [
    ...
    "refresh token", "refresh_token", "galaxyssi fingerprint",
