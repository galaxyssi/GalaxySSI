...
enum AgentIOSRuntimeBrokerInternalInput {
  static let secretEnvironment = "_galaxyssi_secret_environment"
  static let resourceProfile = "_galaxyssi_resource_profile"
...
final class AgentIOSRuntimeBrokerConfigurationStore {
  static let configurationKey = "galaxyssi.ios_runtime_broker.configuration.v1"
...
final class AgentIOSRuntimeBrokerLifecycleStore {
  static let storageKey = "galaxyssi.ios_runtime_broker.lifecycle.v1"
  private let defaults: UserDefaults
...
struct AgentIOSRuntimeBrokerCredentials {
  static let sessionKeyAccount = "galaxyssi.ios_runtime_broker.session_key.v1"

  var secretStore: GalaxySSISecretStore = KeychainSecretStore.shared
...
final class AgentIOSLoopbackRuntimeBrokerTransport: AgentIOSRuntimeBrokerTransport {
  func exchange(
    ...
    let queue = DispatchQueue(label: "com.galaxyssi.ios.runtime-broker", qos: .userInitiated)
...
struct AgentIOSRuntimeBrokerClient: AgentIOSRuntimeBrokerProviding {
  ...
  var implementationId: String = "galaxyssi.ios_runtime_broker.loopback_v1"
