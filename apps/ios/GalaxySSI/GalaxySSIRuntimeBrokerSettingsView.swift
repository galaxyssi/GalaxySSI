...
struct GalaxySSIRuntimeBrokerSettingsView: View {
        ...
        VStack(alignment: .leading, spacing: 12) {
          GalaxySSISecurityHeroView(
            ...
            subtitle: t(
              ...
              "GalaxySSI connects only to a paired runtime service on this iPhone."
            ),
            systemImage: "terminal",
            tint: enabled && credentials.sessionKey() != nil ? .galaxySSIAccent : .orange,
  ...
  private var connectionSection: some View {
    VStack(alignment: .leading, spacing: 8) {
      GalaxySSISecuritySectionTitle(title: t("cc_runtime_broker_connection", "Connection"))
  ...
  private var pairingSection: some View {
    VStack(alignment: .leading, spacing: 8) {
      GalaxySSISecuritySectionTitle(title: t("cc_runtime_broker_pairing", "Pairing"))
      RuntimeBrokerInputShell(
  ...
  private var statusSection: some View {
    VStack(alignment: .leading, spacing: 8) {
      GalaxySSISecuritySectionTitle(title: t("cc_runtime_broker_status", "Broker Status"))
      GalaxySSISecurityActionRow(
        ...
        tint: statusIsFailure ? .orange : .galaxySSIAccent,
        badge: isChecking ? t("galaxyssi.status.loading", "Checking") : ""
      ) {
        checkConnection()
      }
      .disabled(isChecking)
  ...
  private func checkConnection() {
    ...
    isChecking = true
    statusMessage = t("galaxyssi.status.loading", "Checking")
