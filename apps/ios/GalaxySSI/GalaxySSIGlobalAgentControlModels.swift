...
enum GalaxySSIGlobalAgentDetailKind: String, CaseIterable, Identifiable {
  case goals
  case tasks
  case conflicts
  case links
...
struct GalaxySSIGlobalAgentRowItem: Identifiable {
  var id: String
  var title: String
  var subtitle: String
  var systemImage: String
  var badge: String
  var tone: GalaxySSIGlobalAgentTone
}

struct GalaxySSIGlobalAgentDashboardSnapshot {
  ...
  var goals: [GalaxySSIGlobalAgentRowItem]
  var tasks: [GalaxySSIGlobalAgentRowItem]
  var conflicts: [GalaxySSIGlobalAgentRowItem]
  var links: [GalaxySSIGlobalAgentRowItem]
  var cognition: [GalaxySSIGlobalAgentRowItem]
  var runs: [GalaxySSIGlobalAgentRowItem]
  var longHorizon: [GalaxySSIGlobalAgentRowItem]
  var research: [GalaxySSIGlobalAgentRowItem]
  var insights: [GalaxySSIGlobalAgentRowItem]
  var learning: [GalaxySSIGlobalAgentRowItem]
  var continuity: [GalaxySSIGlobalAgentRowItem]
  ...
  static func make(
  ...
  ) -> GalaxySSIGlobalAgentDashboardSnapshot {
    ...
    return GalaxySSIGlobalAgentDashboardSnapshot(
      settings: settings,
  ...
  func rows(for kind: GalaxySSIGlobalAgentDetailKind) -> [GalaxySSIGlobalAgentRowItem] {
    switch kind {
  ...
  func count(for kind: GalaxySSIGlobalAgentDetailKind) -> Int {
    switch kind {
  ...
  private static func goalRows(_ goals: [GlobalLongHorizonGoal]) -> [GalaxySSIGlobalAgentRowItem] {
    goals.sorted { $0.updatedAtMillis > $1.updatedAtMillis }.map { goal in
      GalaxySSIGlobalAgentRowItem(
        id: goal.id,
  ...
  private static func taskRows(_ tasks: [AgentTaskRecord]) -> [GalaxySSIGlobalAgentRowItem] {
  ...
  private static func linkRows(_ sessions: [AgentConversation]) -> [GalaxySSIGlobalAgentRowItem] {
  ...
  private static func cognitionRows(_ tasks: [GlobalCognitionTask]) -> [GalaxySSIGlobalAgentRowItem] {
    tasks.sorted { $0.updatedAtMillis > $1.updatedAtMillis }.map { task in
      GalaxySSIGlobalAgentRowItem(
        id: task.id,
  ...
  private static func runRows(_ runs: [GlobalAutonomousRun]) -> [GalaxySSIGlobalAgentRowItem] {
  ...
  private static func longHorizonRows(_ goals: [GlobalLongHorizonGoal]) -> [GalaxySSIGlobalAgentRowItem] {
    goals.sorted { $0.updatedAtMillis > $1.updatedAtMillis }.map { goal in
      GalaxySSIGlobalAgentRowItem(
        id: goal.id,
        title: goal.title.ifBlank(goal.topic),
  ...
  private static func researchRows(_ tasks: [GlobalResearchTask]) -> [GalaxySSIGlobalAgentRowItem] {
    tasks.sorted { $0.updatedAtMillis > $1.updatedAtMillis }.map { task in
      GalaxySSIGlobalAgentRowItem(
        id: task.id,
        title: task.question,
