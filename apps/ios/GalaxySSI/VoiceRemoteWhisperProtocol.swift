...
struct VoiceRemoteWhisperNodeCapability: Codable, Equatable {
  ...
  init?(
    ...
    self.desktopName = desktopName.trimmingCharacters(in: .whitespacesAndNewlines).ifBlank("GalaxySSI Desktop")
...
enum VoiceRemoteWhisperProtocol {
  static let version = "galaxyssi.remote-whisper/1.0"
  ...
  static func parseCapability(
    ...
    return VoiceRemoteWhisperNodeCapability(
      desktopID: desktopID,
      desktopName: string(executionDevice, "device_name").ifBlank("GalaxySSI Desktop"),
