...
final class LocalModelRuntimeStorage {
  ...
  init(fileManager: FileManager = .default) {
    ...
    rootURL = support.appendingPathComponent("GalaxySSI/LocalModels", isDirectory: true)
  }
  ...
  private func materializeBundledModelIfNeeded(_ profile: LocalModelRuntimeProfile) throws {
      ...
      _ = try installVerifiedFile(
        staged,
        profile: profile,
        downloadURL: URL(string: "bundle://galaxyssi/local-models/\(profile.fileName)")!
      )
    #endif
  }
