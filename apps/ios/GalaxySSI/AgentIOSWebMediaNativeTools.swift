...
enum AgentIOSWebMediaOperation: String, Codable, CaseIterable, Identifiable {
  ...
  case webHead = "galaxyssi.web.head"
  case webFetch = "galaxyssi.web.fetch"
  case webDownload = "galaxyssi.web.download"
  case ocrRecognizeContent = "galaxyssi.ocr.content.recognize"
...
struct AgentIOSUnavailableWebMediaToolProvider: AgentIOSWebMediaToolProviding {
  var implementationId: String = "galaxyssi.ios.web_media_unconfigured"
...
enum AgentIOSWebMediaNativeToolCatalog {
  ...
  static let webHead = "galaxyssi.web.head"
  static let webFetch = "galaxyssi.web.fetch"
  static let webDownload = "galaxyssi.web.download"
  static let ocrRecognizeContent = "galaxyssi.ocr.content.recognize"

  static let executorId = "galaxyssi.ios_web_media_tools"
  static let androidWebExecutorId = "galaxyssi.bounded_https"
  static let androidContentExecutorId = "galaxyssi.android_content_uri"
  static let androidContentExtractExecutorId = "galaxyssi.content_extractor"
  static let androidHandleExecutorId = "galaxyssi.explicit_tool_handles"
  static let publicHttpsNetworkPermission = "galaxyssi.scope.public_https_network"
  static let contentUriPermission = "galaxyssi.scope.user_authorized_content_uri"
  static let browserSessionPermission = "galaxyssi.scope.explicit_browser_session"
  static let localContentPermission = "galaxyssi.scope.local_content_transform"
  static let publicWebConsent = "galaxyssi.consent.public_web"
  static let webDownloadConsent = "galaxyssi.consent.web_download"
  ...
  static let browserSessionConsent = "galaxyssi.consent.browser_session"
  static let localContentExtractConsent = "galaxyssi.consent.local_content_extract"
...
struct AgentIOSWebMediaNativeToolExecutor {
  ...
  private func extractContent(_ invocation: AgentNativeToolInvocation) -> AgentNativeToolExecutionResult {
    ...
    return AgentNativeToolExecutionResult.success(
      ...
      metadata: [
        "implementation": .string("galaxyssi.ios.content_extractor"),
