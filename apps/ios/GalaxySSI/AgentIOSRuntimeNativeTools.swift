...
struct AgentIOSUnavailableOnDeviceRuntimeToolProvider: AgentIOSOnDeviceRuntimeToolProviding {
  var implementationId: String = "galaxyssi.ios.runtime_unconfigured"
...
enum AgentIOSOnDeviceRuntimeNativeToolCatalog {
  static let status = "galaxyssi.runtime.status"
  static let workspaceStatus = "galaxyssi.runtime.workspace.status"
  static let workspaceRollback = "galaxyssi.runtime.workspace.rollback"
  static let listPacks = "galaxyssi.runtime.packs.list"
  static let installPack = "galaxyssi.runtime.packs.install"
  static let softwareCatalog = "galaxyssi.runtime.software.catalog"
  static let softwareSearch = "galaxyssi.runtime.software.search"
  static let softwareInspect = "galaxyssi.runtime.software.inspect"
  static let softwareInstall = "galaxyssi.runtime.software.install"
  static let softwareRemove = "galaxyssi.runtime.software.remove"
  static let execute = "galaxyssi.runtime.execute"

  static let brokerExecutorId = "galaxyssi.ios_runtime_broker"
  static let workspaceExecutorId = "galaxyssi.ios_runtime_workspace"
  static let packManagerExecutorId = "galaxyssi.ios_runtime_pack_manager"
  static let runtimePermission = "galaxyssi.scope.ios_on_device_runtime"
  static let workspacePermission = "galaxyssi.scope.runtime_workspace"
  static let packInstallPermission = "galaxyssi.scope.signed_runtime_pack_install"
  static let softwareInstallPermission = "galaxyssi.scope.on_device_software_install"
