...
struct GalaxySSIVoiceTranscriptSubmission: Equatable {
  var text: String
...
enum VoiceRiskConfirmationMessageFormatter {
  ...
  static func message(
    ...
    guard let correctionReview else {
      return String(
        format: localize(
          "galaxyssi.voice.risk_confirmation_message",
    ...
    return String(
      format: localize(
        "galaxyssi.voice.correction_confirmation_comparison_message",
  ...
  private static func differenceSummary(
    ...
    guard !diff.entityDifferences.isEmpty else {
      return localize(
        "galaxyssi.voice.correction_wording_changed",
  ...
  private static func entityLabel(
    ...
    switch type {
    case .recipient:
      return localize("galaxyssi.voice.entity.recipient", "Recipient")
    case .phoneNumber:
      return localize("galaxyssi.voice.entity.phone_number", "Phone number")
    case .amount:
      return localize("galaxyssi.voice.entity.amount", "Amount")
    case .dateTime:
      return localize("galaxyssi.voice.entity.date_time", "Date or time")
    case .filePath:
      return localize("galaxyssi.voice.entity.file_path", "File path")
    case .application:
      return localize("galaxyssi.voice.entity.application", "Application")
    case .device:
      return localize("galaxyssi.voice.entity.device", "Device")
    case .negation:
      return localize("galaxyssi.voice.entity.negation", "Negation")
    case .action:
      return localize("galaxyssi.voice.entity.action", "Action")
    }
  }
}
