...
struct GalaxySSISignalStoreContext: StoreContext {}

final class GalaxySSISignalProtocolStore: IdentityKeyStore, PreKeyStore, SignedPreKeyStore, KyberPreKeyStore,
