...
struct GalaxySSIAgentExecutionFooterView: View {
  ...
  private var resolvedCancelTitle: String {
    cancelTitle.ifBlank(t("galaxyssi.agent.task_control.cancel", "Cancel task"))
  }

  private var resolvedTimelineActionMenuTitle: String {
    timelineActionMenuTitle.ifBlank(t("galaxyssi.agent.task_control.title", "Task controls"))
  }
