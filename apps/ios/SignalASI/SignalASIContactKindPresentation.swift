...
struct SignalASIContactKindPresentation {
  var title: String
  ...
  ) -> SignalASIContactKindPresentation? {
  ...
  private static func model(t: (String, String) -> String) -> SignalASIContactKindPresentation {
    SignalASIContactKindPresentation(
  ...
  private static func device(t: (String, String) -> String) -> SignalASIContactKindPresentation {
    SignalASIContactKindPresentation(
  ...
  private static func agent(t: (String, String) -> String) -> SignalASIContactKindPresentation {
    SignalASIContactKindPresentation(
...
struct SignalASIContactKindBadge: View {
  var presentation: SignalASIContactKindPresentation
