...
struct OnDeviceAgentPermissionsView: View {
      ...
      ScrollView {
        VStack(alignment: .leading, spacing: 12) {
          OnDeviceAgentHeroView(
            title: t("signalasi.on_device_agent.hero_title", "On-device Agent"),
            subtitle: t("signalasi.on_device_agent.hero_subtitle", "Manage perception, voice, and automation permissions"),
            systemImage: "cpu",
            tint: .blue,
            badge: store.agentSafetySettings.executionPaused
              ? t("signalasi.on_device_agent.status_paused", "Paused")
              : t("signalasi.on_device_agent.status_running", "Running")
          )
          sectionTitle(t("signalasi.on_device_agent.section_execution", "Execution"))
          VStack(spacing: 8) {
            OnDeviceAgentActionRow(
              title: t("signalasi.on_device_agent.permission_mode", "Execution Mode"),
              subtitle: t(
                "signalasi.on_device_agent.permission_mode_subtitle",
            ...
            OnDeviceAgentToggleRow(
              title: t("signalasi.on_device_agent.high_risk_guard", "High-risk Guard"),
              subtitle: t(
                "signalasi.on_device_agent.high_risk_guard_subtitle",
            ...
            OnDeviceAgentToggleRow(
              title: t("signalasi.on_device_agent.execution_pause", "Pause All Execution"),
              subtitle: t(
                "signalasi.on_device_agent.execution_pause_subtitle",
          ...
          sectionTitle(t("signalasi.on_device_agent.section_intelligence", "Planning Intelligence"))
          VStack(spacing: 8) {
            OnDeviceAgentToggleRow(
              title: t("signalasi.on_device_agent.model_planner", "Model-driven Planning"),
              subtitle: t(
                "signalasi.on_device_agent.model_planner_subtitle",
            ...
            OnDeviceAgentToggleRow(
              title: t("signalasi.on_device_agent.model_screen_text", "Share Screen Text for Planning"),
              subtitle: t(
                "signalasi.on_device_agent.model_screen_text_subtitle",
            ...
            OnDeviceAgentNavigationRow(
              title: t("signalasi.on_device_agent.model_source", "Planning Model"),
              subtitle: t(
                "signalasi.on_device_agent.model_source_subtitle",
            ...
            OnDeviceAgentToggleRow(
              title: t("signalasi.on_device_agent.dynamic_replanning", "Dynamic Replanning"),
              subtitle: t(
                "signalasi.on_device_agent.dynamic_replanning_subtitle",
            ...
            OnDeviceAgentActionRow(
              title: t("signalasi.on_device_agent.max_replans", "Maximum Replans"),
              subtitle: t(
                "signalasi.on_device_agent.max_replans_subtitle",
            ...
            OnDeviceAgentToggleRow(
              title: t("signalasi.on_device_agent.multi_agent_coordination", "Multi-Agent Coordination"),
              subtitle: t(
                "signalasi.on_device_agent.multi_agent_coordination_subtitle",
            ...
            OnDeviceAgentToggleRow(
              title: t("signalasi.on_device_agent.share_agent_outputs", "Share Agent Outputs with Planner"),
              subtitle: t(
                "signalasi.on_device_agent.share_agent_outputs_subtitle",
            ...
            OnDeviceAgentActionRow(
              title: t("signalasi.on_device_agent.max_agent_hops", "Maximum Agent Hops"),
              subtitle: t(
                "signalasi.on_device_agent.max_agent_hops_subtitle",
            ...
            OnDeviceAgentActionRow(
              title: t("signalasi.on_device_agent.max_tool_calls", "Maximum Tool Calls"),
              subtitle: t(
                "signalasi.on_device_agent.max_tool_calls_subtitle",
            ...
            OnDeviceAgentActionRow(
              title: t("signalasi.on_device_agent.model_max_actions", "Maximum Planned Actions"),
              subtitle: t(
                "signalasi.on_device_agent.model_max_actions_subtitle",
          ...
          VStack(spacing: 8) {
            ...
            OnDeviceAgentToggleRow(
              ...
              subtitle: t(
                "signalasi.on_device_agent.allow_screen_observation_subtitle",
            ...
            OnDeviceAgentToggleRow(
              title: t("signalasi.on_device_agent.allow_local_actions", "On-device Actions"),
              subtitle: t(
                "signalasi.on_device_agent.allow_local_actions_subtitle",
            ...
            OnDeviceAgentToggleRow(
              title: t("signalasi.on_device_agent.allow_connectors", "Agents and Models"),
              subtitle: t(
                "signalasi.on_device_agent.allow_connectors_subtitle",
            ...
            OnDeviceAgentToggleRow(
              title: t("signalasi.on_device_agent.allow_devices", "Smart Devices"),
              subtitle: t(
                "signalasi.on_device_agent.allow_devices_subtitle",
          ...
          sectionTitle(t("signalasi.on_device_agent.section_permissions", "Permissions"))
          VStack(spacing: 8) {
            OnDeviceAgentStatusRow(
              title: t("signalasi.on_device_agent.screen_access", "Screen Access"),
              subtitle: t(
                "signalasi.on_device_agent.screen_access_subtitle",
            ...
            OnDeviceAgentPermissionRow(
              title: t("signalasi.on_device_agent.location", "Location"),
              subtitle: t("signalasi.on_device_agent.location_subtitle", "Can be disabled for automation scenarios"),
            ...
            OnDeviceAgentPermissionRow(
              title: t("signalasi.on_device_agent.notifications", "Notifications"),
              subtitle: t("signalasi.on_device_agent.notifications_subtitle", "Background message alerts and security prompts"),
  ...
  private var plannerSourceLabel: String {
    ...
    guard !selected.isEmpty,
      ...
      return t("signalasi.on_device_agent.model_source_automatic", "Automatic")
    }
  ...
  private func locationAuthorizationLabel(_ status: CLAuthorizationStatus) -> String {
    ...
    case .authorizedAlways, .authorizedWhenInUse:
      return t("signalasi.permission.while_using", "While in use")
    case .notDetermined:
      return t("signalasi.permission.needs_setup", "Needs setup")
    case .denied, .restricted:
      return t("signalasi.status.protected", "Protected")
