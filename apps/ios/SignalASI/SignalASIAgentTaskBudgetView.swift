...
struct AgentTaskBudgetSettingsView: View {
  ...
  private var profileSection: some View {
    VStack(alignment: .leading, spacing: 8) {
      SignalASISecuritySectionTitle(title: t("cc_task_budget_profile_section", "Budget profile"))
      ForEach(AgentTaskBudgetProfile.allCases) { profile in
        ...
        SignalASISecurityActionRow(
          ...
          tint: selected ? .signalASIAccent : .signalASITextSecondary,
  ...
  private var resourceSection: some View {
    VStack(alignment: .leading, spacing: 8) {
      SignalASISecuritySectionTitle(title: t("cc_task_budget_resource_section", "Resource access"))
      SignalASISecurityActionRow(
        ...
        VStack(alignment: .leading, spacing: 8) {
          ...
          ForEach(AgentTaskNetworkPolicy.allCases) { policy in
            ...
            SignalASISecurityActionRow(
              ...
              tint: selected ? .signalASIAccent : .purple,
