...
enum SignalASIAutomationLabels {
  static func trigger(_ kind: AgentProactiveTriggerKind, language: String) -> String {
    switch kind {
    case .manual:
      return t("signalasi.automation.trigger_manual", "Manual", language: language)
    case .cron:
      return t("signalasi.automation.trigger_cron", "Cron schedule", language: language)
    case .interval:
      return t("signalasi.automation.trigger_interval", "Interval", language: language)
    case .goalCheckpoint:
      return t("signalasi.automation.trigger_goal", "Goal checkpoint", language: language)
    case .webhook:
      return t("signalasi.automation.trigger_webhook", "Trusted webhook", language: language)
    }
  }
  ...
  static func action(_ kind: AgentProactiveActionKind, language: String) -> String {
    switch kind {
    case .agent:
      return t("signalasi.automation.action_agent", "Agent", language: language)
    case .subagentTeam:
      return t("signalasi.automation.action_team", "Sub-agent team", language: language)
    case .workflow:
      return t("signalasi.automation.action_workflow", "Saved workflow", language: language)
    case .nativeTool:
      return t("signalasi.automation.action_tool", "Phone tool", language: language)
    }
  }
  ...
  static func delivery(_ value: String, language: String) -> String {
    switch value {
    case "notify":
      return t("signalasi.automation.delivery_notify", "Store and notify", language: language)
    case "mobile":
      return t("signalasi.automation.delivery_mobile", "Deliver through SignalASI Link", language: language)
    default:
      return t("signalasi.automation.delivery_store", "Store result", language: language)
    }
  }
  ...
  static func network(_ value: String, language: String) -> String {
    switch value {
    case "unmetered":
      return t("signalasi.automation.network_unmetered", "Unmetered network", language: language)
    case "offline":
      return t("signalasi.automation.network_offline", "Offline only", language: language)
    default:
      return t("signalasi.automation.network_any", "Any network state", language: language)
    }
  }
  ...
  static func status(_ status: AgentProactiveRunStatus, language: String) -> String {
    switch status {
    case .queued:
      return t("signalasi.agent_task.status_queued", "Queued", language: language)
    case .running, .retrying:
      return t("signalasi.automation.status_running", "Running", language: language)
    case .waiting:
      return t("signalasi.automation.status_waiting", "Waiting", language: language)
    case .completed:
      return t("signalasi.automation.status_completed", "Completed", language: language)
    case .failed:
      return t("signalasi.automation.status_failed", "Failed", language: language)
    case .cancelled:
      return t("signalasi.automation.status_cancelled", "Cancelled", language: language)
    case .skipped:
      return t("signalasi.automation.status_skipped", "Skipped", language: language)
    }
  }
