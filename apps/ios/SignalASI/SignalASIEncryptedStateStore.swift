...
enum SignalASIEncryptedStateStore {
  static let stateKey = "signalasi-ios-state-v2"
  static let legacyStateKey = "signalasi-ios-state-v1"

  private static let keychainAccount = "state.encryption.aes256"
  private static let associatedData = Data("com.signalasi.chat.ios.state.v2".utf8)
  ...
  static func destroy(defaults: UserDefaults, secrets: SignalASISecretStore) {
