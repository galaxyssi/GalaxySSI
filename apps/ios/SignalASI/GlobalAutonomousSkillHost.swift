...
final class GlobalAutonomousSkillHost {
  ...
  private func scopedStepInput(
    ...
    guard !workspaceId.isBlank, toolId.hasPrefix("signalasi.workspace.") else {
      return input
    }
    var scoped = input
  ...
  private static let toolIdPrefix = "signalasi.skill."
  private static let agentOrchestrationToolId = "signalasi.agent.orchestrate"
