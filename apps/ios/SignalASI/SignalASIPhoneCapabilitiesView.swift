...
struct SignalASIPhoneCapabilitiesView: View {
  ...
  private var banner: some View {
    let tone: Color = attentionCount == 0 ? .signalASIAccent : .orange
  ...
  private var deviceControlSection: some View {
    VStack(alignment: .leading, spacing: 8) {
      SignalASISecuritySectionTitle(title: t("cc_section_device_control", "Device Control"))
      capabilityRow(
