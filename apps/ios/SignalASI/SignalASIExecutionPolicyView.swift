...
struct SignalASIExecutionPolicyView: View {
  ...
  private var permissionModeSection: some View {
    VStack(alignment: .leading, spacing: 8) {
      SignalASISecuritySectionTitle(title: t("cc_permission_mode_section", "Action Permissions"))
  ...
  private var confirmationRulesSection: some View {
    VStack(alignment: .leading, spacing: 8) {
      SignalASISecuritySectionTitle(title: t("cc_section_confirmation_rules", "Confirmation Rules"))
  ...
  private var taskControlSection: some View {
    VStack(alignment: .leading, spacing: 8) {
      SignalASISecuritySectionTitle(title: t("cc_section_task_control", "Task Control"))
      SignalASISecurityStatusRow(
      ...
      SignalASISecurityActionRow(
        ...
        badge: notificationsEnabled ? t("signalasi.status.enabled", "Enabled") : t("signalasi.status.needs_setup", "Needs Setup")
      ) {
  ...
  private var privacyBoundarySection: some View {
    VStack(alignment: .leading, spacing: 8) {
      ...
      SignalASISecurityNavigationRow(
        ...
        systemImage: "lock.shield",
        tint: privacyProtected ? .signalASIAccent : .orange,
        badge: privacyProtected ? t("signalasi.status.enabled", "Enabled") : t("cc_status_review", "Review")
      ) {
        AgentModelPlannerSettingsView()
      }
    }
...
private struct SignalASIExecutionPolicyToggleRow: View {
  var title: String
  var subtitle: String
