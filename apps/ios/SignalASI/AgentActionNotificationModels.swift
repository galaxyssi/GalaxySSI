...
enum AgentActionNotificationPolicy {
  static let channelId = "signalasi_phone_operations"
  static let defaultPrivateText = "SignalASI is performing a private Agent operation."
  ...
  static func taskId(for action: AgentAction) -> String {
    let taskId = clean(action.parameters["_signalasi_task_id"] ?? "")
