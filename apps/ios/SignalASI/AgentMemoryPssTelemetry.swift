...
final class UserDefaultsAgentMemoryPssSampleStore: AgentMemoryPssSampleStore {
  static let defaultKey = "signalasi_agent_memory_pss"
...
final class AgentMemoryPssMonitor {
  ...
  static func providerIdForAgent(_ agentId: String) -> String {
    ...
    switch clean {
    case "signalasi-mobile", "mobile", "on-device":
      return "on-device"
    default:
  ...
  private func sample(
    ...
    let agentId = cleanAgentId.ifBlank(workspace == nil ? "" : "signalasi-mobile")
...
enum AgentMemoryPssRuntime {
  ...
  private static let queue = DispatchQueue(label: "SignalASI.AgentMemoryPss")
