...
enum AgentIOSDesktopRemoteNativeToolCatalog {
  static let systemStatus = "signalasi.desktop.windows.system.status"
  static let processList = "signalasi.desktop.windows.process.list"
  static let fileList = "signalasi.desktop.workspace.file.list"
  static let fileReadText = "signalasi.desktop.workspace.file.read.text"
  static let fileWriteText = "signalasi.desktop.workspace.file.write.text"
  static let fileSha256 = "signalasi.desktop.workspace.file.sha256"
  static let archiveCreate = "signalasi.desktop.workspace.archive.create"
  static let terminalRun = "signalasi.desktop.terminal.run"
  static let officeInspect = "signalasi.desktop.office.document.inspect"
  static let officeConvert = "signalasi.desktop.office.document.convert"

  static let version = "1.1.0"
  static let executorId = "signalasi.desktop_remote"
  static let readConsent = "signalasi.consent.desktop.read"
  static let executeConsent = "signalasi.consent.desktop.execute"
  static let linkPermission = "signalasi.scope.secure_paired_desktop_link"
  static let workspacePermission = "signalasi.scope.desktop_task_workspace"
  ...
  private static func permissionRequirements(_ kind: AgentIOSDesktopRemoteToolKind) -> [AgentNativePermissionRequirement] {
    var requirements = [
      AgentNativePermissionRequirement(
        ...
        description: "Requires an online encrypted SignalASI Link session to the selected Desktop."
      )
    ]
