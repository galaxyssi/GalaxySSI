...
final class AgentControlPlaneTeamDispatchCoordinator {
  ...
  private static func baseContext(spec: AgentTeamDispatchSpec, action: AgentAction) -> AgentMcpJSONObject {
    [
      ...
      "_signalasi_agent_team_id": .string(spec.definition.teamId),
      "_signalasi_agent_team_role": .string("supervisor"),
      "_signalasi_agent_team_visibility": .string(spec.definition.visibilityMode.rawValue)
    ]
  }
