...
struct AgentModelPlannerSettingsView: View {
      ...
      ScrollView {
        VStack(alignment: .leading, spacing: 12) {
          SignalASISecurityHeroView(
            ...
            badge: plannerReady ? t("signalasi.status.ready", "Ready") : t("status_needs_setup", "Needs setup")
          )
          intelligenceSection
          taskControlSection
          privacySection
  ...
  private var plannerSourceLabel: String {
    ...
    return String(format: t("signalasi.missing_format", "Missing: %@"), selected)
  }
        ...
        VStack(alignment: .leading, spacing: 8) {
          ...
          if selectedSourceMissing {
            sourceRow(
              ...
              title: String(format: t("signalasi.missing_format", "Missing: %@"), store.modelPlannerSettings.cloudContactId),
