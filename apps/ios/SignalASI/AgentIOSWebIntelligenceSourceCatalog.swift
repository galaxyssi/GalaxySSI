...
final class AgentIOSWebIntelligenceLearningStore {
  private static let learnedSourceCountKey = "signalasi.web_intelligence.learned_source_count"
  private static let verifiedLearnedSourceCountKey = "signalasi.web_intelligence.verified_learned_source_count"
...
struct AgentIOSWebIntelligenceCredentials {
  var secrets: SignalASISecretStore = KeychainSecretStore.shared
