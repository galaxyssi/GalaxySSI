...
struct SignalASIPeerAttachmentTransferUpdate: Equatable {
...
enum SignalASIPeerAttachmentTransferProgress {
  ...
  static func applying(
    _ update: SignalASIPeerAttachmentTransferUpdate,
  ...
  static func placeholder(_ update: SignalASIPeerAttachmentTransferUpdate) -> String {
    AgentRichContentCodec.encode([block(for: update)])
  }

  private static func block(for update: SignalASIPeerAttachmentTransferUpdate) -> AgentRichBlock {
    var metadata = [
      "source": "peer_message",
...
struct SignalASIPeerImageTransferProgressOverlay: View {
  var progress: Int
