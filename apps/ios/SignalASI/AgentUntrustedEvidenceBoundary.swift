...
enum AgentUntrustedEvidenceBoundary {
  static let contractVersion = "signalasi.untrusted-evidence/1.0"
  static let metadataKey = "_signalasi_trust_boundary"
  static let policyMarker = "SignalASI untrusted evidence policy"
