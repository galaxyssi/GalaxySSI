...
struct SignalASIResetDataView: View {
  ...
  var body: some View {
    ...
    .alert(t("cc_reset_dialog_title", "Reset SignalASI?"), isPresented: $showingConfirmation) {
      ...
      Text(t(
        ...
        "This permanently removes local identity, keys, contacts, conversations, Agent data, knowledge, settings, cache, and exported backups stored by SignalASI. Type RESET to continue."
      ))
    }
  }
  ...
  private var scopeSection: some View {
    VStack(alignment: .leading, spacing: 8) {
      SignalASISecuritySectionTitle(title: t("destroy_data_scope", "Clear Scope"))
      SignalASISecurityStatusRow(
        title: t("destroy_data_regenerate_identity", "Regenerate Identity"),
        subtitle: t("destroy_data_regenerate_identity_subtitle", "Create a new SignalASI ID and identity fingerprint"),
  ...
  private var confirmationSection: some View {
    VStack(alignment: .leading, spacing: 8) {
      SignalASISecuritySectionTitle(title: t("cc_reset_confirmation_section", "Final Confirmation"))
      SignalASISecurityActionRow(
        title: t("cc_reset_begin_title", "Review and reset SignalASI"),
      ...
      if !confirmationError.isEmpty {
        SignalASISecurityStatusRow(
          title: t("cc_reset_dialog_title", "Reset SignalASI?"),
