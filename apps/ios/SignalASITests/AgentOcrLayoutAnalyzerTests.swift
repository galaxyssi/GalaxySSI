...
final class AgentOcrLayoutAnalyzerTests: XCTestCase {
  func testAutoModeMergesMixedScriptsWithoutDuplicatingSpatialMatches() {
    let chinese = AgentOcrCandidate(
      script: .chinese,
      fallbackText: "SignalASI \u{63a7}\u{5236}\u{4e2d}\u{5fc3}",
      lines: [
        line("SignalASI", left: 10, top: 10, right: 150, bottom: 40, language: "zh", block: 0),
        line("\u{63a7}\u{5236}\u{4e2d}\u{5fc3}", left: 10, top: 55, right: 170, bottom: 90, language: "zh", block: 0)
      ]
    )
    let latin = AgentOcrCandidate(
      script: .latin,
      fallbackText: "SignalASI Ready",
      lines: [
        line("SignalASI", left: 12, top: 11, right: 151, bottom: 41, language: "Latn", block: 0),
    ...
    XCTAssertEqual(merged.lines.filter { $0.text == "SignalASI" }.count, 1)
