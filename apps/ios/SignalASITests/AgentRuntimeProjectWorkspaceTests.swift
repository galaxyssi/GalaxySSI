...
extension SignalASIStoreTests {
  func testAgentRuntimeProjectWorkspacePersistsAcrossIsolatedRequests() throws {
    ...
    try Data("private runtime output".utf8).write(to: first.directory.appendingPathComponent(".signalasi-stdout"))
    ...
    XCTAssertFalse(FileManager.default.fileExists(atPath: project.appendingPathComponent(".signalasi-stdout").path))
