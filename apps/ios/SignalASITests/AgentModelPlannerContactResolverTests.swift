...
final class AgentModelPlannerContactResolverTests: XCTestCase {
  ...
  func testAgentModelPlannerContactResolverRejectsUnsafeCandidates() {
    ...
    XCTAssertNil(resolve(makeCloudContact(id: "cloud:smoke-key"), apiKey: "sk-signalasi-smoke-key"))
  ...
  private func makeCloudContact(
    ...
    deliveryMode: SignalASIDeliveryMode = .cloudAPI,
    deleted: Bool = false
  ) -> SignalASIContact {
