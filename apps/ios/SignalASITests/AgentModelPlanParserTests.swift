...
final class AgentModelPlanParserTests: XCTestCase {
  func testAgentModelPlanParserBuildsBoundedExecutablePlanFromFencedJson() throws {
    let descriptor = try nativeToolDescriptor(id: "signalasi.web.search", risk: .low)
    let raw = """
    ```json
    {
    ...
    XCTAssertEqual(plan.actions[1].parameters["tool_id"], "signalasi.web.search")
    XCTAssertEqual(plan.actions[1].parameters["tool_version"], "1.0.0")
    XCTAssertEqual(plan.actions[1].parameters["native_tool_risk"], "low")
    XCTAssertEqual(plan.actions[1].parameters["input_json"], #"{"query":"SignalASI iOS"}"#)
  ...
  func testAgentModelPlanParserResolvesScreenElementsAppsUrlsAndNotifications() throws {
    ...
    {"actions":[
      ...
      {"ref":"open_url","kind":"OPEN_URL","parameters":{"url":"https://signalasi.com/docs"}},
    ...
    XCTAssertEqual(plan.actions[3].parameters["url"], "https://signalasi.com/docs")
    XCTAssertEqual(plan.actions[4].parameters["title"], "SignalASI Agent")
  }
  ...
  func testAgentModelPlanParserRejectsUnavailableNativeToolAndConnector() throws {
    ...
    XCTAssertNil(AgentModelPlanParser.parse(
      ...
      raw: planJson("""
      {"ref":"tool","kind":"CALL_NATIVE_TOOL","parameters":{"tool_id":"signalasi.web.search","arguments":{}}}
      """),
      settings: AgentModelPlannerSettings(),
      context: context()
    ))
  ...
  func testAgentModelPlanParserUsesMcpCallToolProvisionalRisk() throws {
    ...
    let plan = try XCTUnwrap(AgentModelPlanParser.parse(
      ...
      {"ref":"mcp","kind":"CALL_NATIVE_TOOL","parameters":{
        "tool_id":"signalasi.mcp.tool.call",
  ...
  private func request(
    ...
    AgentPlanRequest(
      ...
      screen: AgentScreenContext(foregroundApp: "SignalASI", pageTitle: "Agent", isAccessibilityEnabled: true),
