...
final class SignalASIStoreTests: XCTestCase {
  ...
  func makeStore() -> SignalASIStore {
    makeStore(secrets: InMemorySecretStore())
  }

  func makeStore(secrets: SignalASISecretStore) -> SignalASIStore {
  ...
  func makeFriendRequest(signalASIId: String, name: String) -> SignalASIFriendRequest {
