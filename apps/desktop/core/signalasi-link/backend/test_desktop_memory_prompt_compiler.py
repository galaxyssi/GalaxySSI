...
class DesktopMemoryPromptCompilerTest(unittest.TestCase):
    ...
    def test_compiles_typed_relationships_with_evidence_ids(self):
        ...
        graph = {
            "nodes": [
                {"id": "phone", "label": "SignalASI phone"},
        ...
        self.assertIn('"SignalASI phone" supports "Gemma model"', result.text)
    ...
    def test_prompt_injection_text_remains_quoted_untrusted_evidence(self):
        ...
        self.assertIn("- DATA [project:signalasi/project_state]", result.text)
...
def memory(
    ...
    content: str,
    *,
    namespace: str = "project:signalasi",
