...
explicit ``signalasi-jsonl-v1`` capability and never guesses from a command
    ...
    def __init__(
        ...
        *,
        ...
        self._stdout_thread = threading.Thread(
            ...
            daemon=True,
            name=f"signalasi-cli-out-{worker_id}",
        )
        self._stderr_thread = threading.Thread(
            target=self._read_stderr,
            daemon=True,
            name=f"signalasi-cli-err-{worker_id}",
        )
        ...
        *,
        ...
        if start_janitor:
            self._janitor_thread = threading.Thread(
                ...
                daemon=True,
                name="signalasi-cli-pool-janitor",
            )
