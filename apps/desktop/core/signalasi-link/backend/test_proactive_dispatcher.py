...
class DesktopProactiveDispatcherTests(unittest.TestCase):
    ...
    def test_team_goal_checkpoint_uses_only_lead_state_and_completes(self):
        ...
        self.assertNotIn("SIGNALASI_GOAL_STATUS", output["reply"])
        self.assertIn("SIGNALASI_GOAL_STATUS", prompts["codex"])
        self.assertNotIn("SIGNALASI_GOAL_STATUS", prompts["hermes"])
