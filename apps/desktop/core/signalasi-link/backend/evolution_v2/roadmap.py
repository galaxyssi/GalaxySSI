...
class RoadmapPlanner:
    ...
    def create(self, goal: str, research_runs: Iterable[ResearchRun] = ()) -> RoadmapPlan:
        ...
        plan = RoadmapPlan(
            ...
            title="SignalASI Super Agent Evolution Roadmap",
            goal=str(goal or "Evolve SignalASI into a safe, interoperable, durable personal super Agent.")[:2_000],
            ...
            items=[
                ...
                _item(
                    ...
                    "SignalASI can discover, authorize and route tools, Agents and portable skills through versioned adapters.",
                    "Open protocols reduce lock-in and let SignalASI remain the neutral control plane.",
                ...
                _item(
                    ...
                    "SignalASI learns durable user preferences and skills from outcomes while preserving provenance, correction and deletion.",
                ...
                _item(
                    ...
                    "SignalASI's advantage is persistent coordination across models, Agents, compute nodes and devices.",
                ...
                _item(
                    ...
                    "SignalASI can propose and implement new capabilities, but promotion requires formal policies, adversarial evaluation and reversible deployment.",
