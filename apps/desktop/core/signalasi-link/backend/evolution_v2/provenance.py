...
class ProvenanceWriter:
    ...
    def write(
        ...
        *,
        ...
        subject = {
            "name": "SignalASI evolution candidate",
        ...
        statement = {
            ...
            "predicate": {
                "buildDefinition": {
                    "buildType": "https://signalasi.org/evolution/worktree/v2",
                    "externalParameters": {
                ...
                "runDetails": {
                    "builder": {"id": "SignalASI Desktop Self-Evolution V2"},
                    "metadata": {
            ...
            "signalasi": {
                "protocol": "signalasi.evolution-provenance.v2",
                "host": {
