...
DEFAULT_POLICY: dict[str, Any] = {
    "schema": "signalasi.evolution-policy.v2",
    "publish": {
    ...
    "critical_paths": [
        "apps/desktop/core/signalasi-link/backend/crypto",
        "apps/desktop/core/signalasi-link/backend/pairing",
        "apps/desktop/core/signalasi-link/backend/desktop_control",
        "apps/desktop/core/signalasi-link/backend/evolution_manager.py",
        "apps/desktop/core/signalasi-link/backend/evolution_v2/api.py",
        "apps/desktop/core/signalasi-link/backend/evolution_v2/audit.py",
        "apps/desktop/core/signalasi-link/backend/evolution_v2/github_client.py",
        "apps/desktop/core/signalasi-link/backend/evolution_v2/manager.py",
        "apps/desktop/core/signalasi-link/backend/evolution_v2/provenance.py",
        "apps/desktop/core/signalasi-link/backend/evolution_v2/snapshots.py",
        "apps/android/app/src/main/AndroidManifest.xml",
        "apps/android/app/src/main/java/com/signalasi/chat/security",
        "apps/android/app/src/main/java/com/signalasi/chat/accessibility",
        ".github/workflows",
    ],
    "high_risk_paths": [
        "apps/desktop/core/signalasi-link/backend/mqtt_bridge.py",
        "apps/desktop/core/signalasi-link/backend/agent_gateway.py",
    ...
    "dependency_files": [
        ...
        "apps/android/app/build.gradle.kts",
        "apps/desktop/core/signalasi-link/backend/requirements.txt",
    ],
    "secret_patterns": [
        "github_pat_",
        "ghp_",
