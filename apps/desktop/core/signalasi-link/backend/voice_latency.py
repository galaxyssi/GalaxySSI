...
VOICE_LATENCY_TRACE_FLAG = "SIGNALASI_VOICE_LATENCY_TRACING_V1"
VOICE_LATENCY_SCHEMA = "signalasi.voice-latency/1.0"
DEFAULT_TRACE_PATH = Path.home() / ".signalasi" / "diagnostics" / "voice_latency_v1.jsonl"
