...
CORE_COMMANDS: tuple[CommandDefinition, ...] = (
    CommandDefinition(
        ...
        "commands",
        "list",
        "List registered SignalASI commands and handler availability.",
        aliases=("/commands",),
    ...
    CommandDefinition(
        ...
        "process",
        "output",
        "Read stdout and stderr logs for a SignalASI-managed process.",
    ...
    CommandDefinition(
        ...
        "process",
        "stdin",
        "Write a line to stdin for a SignalASI-managed process.",
        risk="high",
        requires_approval=True,
        required_permission="workspace.write",
    ...
    CommandDefinition(
        ...
        "process",
        "kill",
        "Force-kill a SignalASI-managed process.",
        risk="high",
        requires_approval=True,
        required_permission="workspace.write",
