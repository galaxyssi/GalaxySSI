...
STAGE_PAIRS = {
    ...
    "desktop_ingress_queue_ms": ("desktop_request_received", "desktop_handler_started"),
    "desktop_route_resolve_ms": ("desktop_handler_started", "desktop_wire_open_started"),
    "desktop_wire_open_ms": ("desktop_wire_open_started", "desktop_wire_open_finished"),
    "desktop_wire_prepare_ms": ("desktop_wire_open_finished", "desktop_replay_lookup_started"),
    "desktop_replay_lookup_ms": ("desktop_replay_lookup_started", "desktop_decrypt_started"),
    "desktop_signal_decrypt_ms": ("desktop_decrypt_started", "desktop_signal_decrypt_finished"),
    "desktop_inbound_accept_ms": ("desktop_signal_decrypt_finished", "desktop_request_decrypted"),
