...
MOBILE_CONTEXT_HEADER = "[GALAXYSSI_CONVERSATION_CONTEXT_V1]"
MOBILE_CONTEXT_FOOTER = "[/GALAXYSSI_CONVERSATION_CONTEXT_V1]"
...
class ConversationSummaryStore:
    def __init__(self, path: Path | None = None) -> None:
        self.path = path or (Path.home() / ".galaxyssi" / "conversation_context_summaries.json")
