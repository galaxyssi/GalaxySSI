...
class RichImageResultMatrixTests(unittest.TestCase):
        ...
        for index, (extension, uri_style) in enumerate(
            ...
            with self.subTest(label):
                ...
                if uri_style == "backslash":
                    ...
                    uri = f"galaxyssi-artifact://previous-task/{relative}"
    ...
    def _run_invalid_reference_cases(self, executed: list[str]) -> None:
        references = (
            ...
            "galaxyssi-artifact://task/scripts/result.jpg",
            "galaxyssi-artifact://task/downloads/input/private.jpg",
        ...
        for index, reference in enumerate(references):
            ...
            with self.subTest(label):
                ...
                self.assertNotIn("galaxyssi-rich", fallback)
