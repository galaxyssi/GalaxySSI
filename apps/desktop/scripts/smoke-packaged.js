...
async function main() {
  ...
  const pythonCheck = spawn(
    bundledPython,
    ["-c", "import cryptography, fastapi, multipart, uvicorn, paho.mqtt.client, sqlalchemy, pydantic, websockets, qrcode, markdown_it, agent_task_store, backend_instance_lock, conversation_context, desktop_agent_adapters, desktop_control, desktop_native_tools, evolution_v2.api, evolution_v2.manager, mqtt_bridge, phone_tool_broker, rich_output, unified_commands; print('ok')"],
