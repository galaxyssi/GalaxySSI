(function (root) {
  const labels = {
    ...
    desktop_receive_queue_ms: 'Receive to Signal decrypt',
    desktop_ingress_queue_ms: 'Inbound worker queue',
    desktop_route_resolve_ms: 'Inbound route lookup',
    desktop_wire_open_ms: 'Outer envelope decrypt and parse',
    desktop_wire_prepare_ms: 'Fragment and envelope preparation',
    desktop_replay_lookup_ms: 'Encrypted replay lookup',
    desktop_signal_decrypt_ms: 'Signal envelope decrypt',
    desktop_inbound_accept_ms: 'Validate and accept inbound message',
