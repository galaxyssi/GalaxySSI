...
class GlobalAgentCognitionTest {
        ...
        val world = PersonalWorldModel(
            items = listOf(
                worldItem(
                    ...
                    value = "GalaxySSI should support an Android on-device Agent runtime",
    ...
    fun reducerMergesRepeatedEvidenceFromDifferentConversations() {
        val firstEvent = event("conversation-a", "GalaxySSI", "We need an on-device Agent runtime")
