...
class GlobalBackgroundCognitionPolicyTest {
    ...
    fun `explicit paired authorization only opens global background conversations`() {
        ...
        assertTrue(GalaxySSITransportPrivacyPolicy.isLocalOnly(cognition))
        assertFalse(GalaxySSITransportPrivacyPolicy.isLocalOnly(cognition, true))
        assertTrue(GalaxySSITransportPrivacyPolicy.isLocalOnly(evolution, true))
    }
