...
class LocalModelStorageTest {
    ...
    private val profile by lazy {
        LocalModelRuntimeProfile(
            ...
            repositoryId = "signalasi/test-model",
    ...
    fun onlyVerifiedPartialCanBeCommittedAndLoaded() {
        ...
        val installed = storage.commitVerifiedPartial(profile, "https://huggingface.co/signalasi/test-model")
    ...
    fun changedInstalledFileInvalidatesVerificationCache() {
        ...
        storage.commitVerifiedPartial(profile, "https://huggingface.co/signalasi/test-model")
