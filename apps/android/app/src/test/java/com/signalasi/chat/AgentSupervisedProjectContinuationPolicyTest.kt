...
class AgentSupervisedProjectContinuationPolicyTest {
    ...
    fun continuationRestoresTheLatestPhoneProjectGoal() {
        val context = AgentConversationContext(
            ...
            turns = listOf(
                entry(
                    ...
                    "Clone https://github.com/signalasi/SignalASI, update it, make a small change, test it, and create a PR"
                ),
        ...
        assertTrue(merged.orEmpty().contains("Clone https://github.com/signalasi/SignalASI"))
