...
class GalaxySSINotificationListenerService : NotificationListenerService() {
    ...
    companion object {
        private const val TAG = "GalaxySSINotification"
        ...
        @Volatile
        private var activeService: GalaxySSINotificationListenerService? = null
