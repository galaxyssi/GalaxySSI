...
private class AgentRuntimeEncryptedReceiptPersistence(context: Context) : AgentRuntimeReceiptPersistence {
    private val database = AgentEncryptedDatabase(context.applicationContext, "galaxyssi_runtime_receipts_v2")
...
class AgentRuntimeWorkspaceManager private constructor(
    ...
    companion object {
        ...
        private const val CHECKPOINT_MANIFEST = ".galaxyssi-checkpoint.json"
