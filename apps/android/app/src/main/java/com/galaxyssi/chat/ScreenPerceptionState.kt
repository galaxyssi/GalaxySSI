...
object ScreenPerceptionState {
    ...
    private fun shouldPreferVisualOnly(
        ...
        snapshot.packageName == GALAXYSSI_PACKAGE
    ...
    private fun displayPackageName(packageName: String, defaultApp: String): String {
        ...
        return if (resolvedPackage == "com.galaxyssi.chat" && defaultApp == "GalaxySSI") {
            defaultApp
        } else {
            resolvedPackage
        }
    ...
    private const val GALAXYSSI_PACKAGE = "com.galaxyssi.chat"
