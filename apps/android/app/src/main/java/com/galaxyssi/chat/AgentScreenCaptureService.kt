...
class AgentScreenCaptureService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        captureThread = HandlerThread("GalaxySSI-AgentScreenCapture").apply { start() }
    ...
    companion object {
        private const val ACTION_START = "com.galaxyssi.chat.action.START_AGENT_SCREEN_CAPTURE"
        private const val ACTION_CAPTURE = "com.galaxyssi.chat.action.CAPTURE_AGENT_SCREEN"
        private const val ACTION_STOP = "com.galaxyssi.chat.action.STOP_AGENT_SCREEN_CAPTURE"
        ...
        private const val CHANNEL_ID = "galaxyssi_agent_screen_capture"
