...
object AgentLinuxSoftwareNativeTools {
    const val CATALOG = "galaxyssi.runtime.software.catalog"
    const val SEARCH = "galaxyssi.runtime.software.search"
    const val INSPECT = "galaxyssi.runtime.software.inspect"
    const val INSTALL = "galaxyssi.runtime.software.install"
    const val REMOVE = "galaxyssi.runtime.software.remove"
    ...
    private fun definition(
        ...
        executorId = "galaxyssi.android_linux_software",
