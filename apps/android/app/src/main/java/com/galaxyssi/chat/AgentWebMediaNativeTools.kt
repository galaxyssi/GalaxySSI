...
class AgentBoundedWebService(
    ...
    private fun requestHeaders(
        ...
        "User-Agent" to "GalaxySSI-Android-NativeTools/1.0"
    ).apply {
...
object AgentWebMediaNativeTools {
    ...
    const val WEB_HEAD = "galaxyssi.web.head"
    const val WEB_FETCH = "galaxyssi.web.fetch"
    const val WEB_DOWNLOAD = "galaxyssi.web.download"
    const val OCR_RECOGNIZE_CONTENT = "galaxyssi.ocr.content.recognize"
    const val MEDIA_METADATA = "galaxyssi.media.metadata"
    const val MEDIA_PLAYBACK_HANDOFF = "galaxyssi.media.playback.handoff"
    const val MEDIA_FFMPEG_TRANSCODE = "galaxyssi.media.ffmpeg.transcode"

    const val INTERNET_PERMISSION = "android.permission.INTERNET"
    const val PUBLIC_WEB_CONSENT = "galaxyssi.consent.public_web"
    const val WEB_DOWNLOAD_CONSENT = "galaxyssi.consent.web_download"
    const val CONTENT_URI_READ_CONSENT = "galaxyssi.consent.content_uri_read"
    const val CONTENT_URI_WRITE_CONSENT = "galaxyssi.consent.content_uri_write"
    const val MEDIA_PLAYBACK_CONSENT = "galaxyssi.consent.media_playback"
    ...
    private const val WEB_EXECUTOR_ID = "galaxyssi.bounded_https"
    private const val CONTENT_EXECUTOR_ID = "galaxyssi.android_content_uri"
    private const val MEDIA_EXECUTOR_ID = "galaxyssi.android_media_handoff"
    private const val MEDIA_TRANSCODE_EXECUTOR_ID = "galaxyssi.android_runtime.ffmpeg"
    ...
    private fun browserSessionCloseDefinition(
        ...
        executorId = "galaxyssi.explicit_tool_handles",
    ...
    private fun contentExtractDefinition() = AgentNativeToolDefinition(
        ...
        executorId = "galaxyssi.content_extractor"
    )
