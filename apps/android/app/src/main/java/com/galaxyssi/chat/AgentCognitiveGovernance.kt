...
class AgentAttentionDecisionStore(context: Context) {
    ...
    private companion object {
        const val DATABASE = "galaxyssi_attention_decisions_v1"
...
class AgentCognitiveGovernanceStore(context: Context) {
    ...
    private companion object {
        const val DATABASE = "galaxyssi_cognitive_governance_v1"
...
class AgentProtocolEndpointGrantStore(context: Context) {
    ...
    private companion object {
        const val DATABASE = "galaxyssi_protocol_endpoint_grants_v1"
