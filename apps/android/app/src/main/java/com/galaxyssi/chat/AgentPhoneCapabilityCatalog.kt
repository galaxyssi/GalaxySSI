...
object AgentPhoneCapabilityCatalog {
    val capabilities: List<AgentPhoneCapabilityBoundary> = listOf(
        ...
        AgentPhoneCapabilityBoundary(
            ...
            risk = AgentRisk.HIGH,
            normalAppCanExecute = true,
            limitation = "GalaxySSI supports one bounded foreground location fix; Android can return approximate, stale, disabled, or unavailable results and no background tracking is exposed."
        ),
        AgentPhoneCapabilityBoundary(
            ...
            normalAppCanExecute = true,
            limitation = "GalaxySSI lists sensor metadata and samples one bounded non-health sensor in the foreground; continuous, background, body, and health streams are excluded."
        ),
        AgentPhoneCapabilityBoundary(
            ...
            risk = AgentRisk.HIGH,
            normalAppCanExecute = true,
            limitation = "GalaxySSI reads adapter status, performs one bounded foreground discovery, and hands pairing to Android Settings; silent pairing, connection, and protocol traffic are excluded."
        ),
        AgentPhoneCapabilityBoundary(
            ...
            risk = AgentRisk.HIGH,
            normalAppCanExecute = true,
            limitation = "GalaxySSI reads NFC adapter availability and enabled state only; tag capture, writes, secure-element access, and payment operations are excluded."
        ),
        AgentPhoneCapabilityBoundary(
        ...
        AgentPhoneCapabilityBoundary(
            ...
            risk = AgentRisk.HIGH,
            normalAppCanExecute = true,
            limitation = "GalaxySSI has no installer handoff; an ordinary app can only request the system installer and cannot silently install, approve, or verify arbitrary packages."
        ),
        AgentPhoneCapabilityBoundary(
        ...
        AgentPhoneCapabilityBoundary(
            ...
            risk = AgentRisk.BLOCKED,
            normalAppCanExecute = false,
            limitation = "GalaxySSI does not execute su commands; root presence is device-specific, bypasses Android's app boundary, and is intentionally never advertised as ready."
        ),
        AgentPhoneCapabilityBoundary(
    ...
    private fun observe(
        ...
        AgentPhoneCapabilityId.ACCESSIBILITY_GESTURES -> {
            val active = GalaxySSIAccessibilityService.isActive()
            AgentPhoneCapabilityObservation(
        ...
        AgentPhoneCapabilityId.NOTIFICATION_READ -> {
            val connected = GalaxySSINotificationListenerService.currentContext().hasAccess
            AgentPhoneCapabilityObservation(
        ...
        AgentPhoneCapabilityId.NOTIFICATION_REPLY -> {
            val notificationContext = GalaxySSINotificationListenerService.currentContext()
            AgentPhoneCapabilityObservation(
                implementationPresent = AgentPhoneCapabilityNativeCoverage.isImplemented(id),
