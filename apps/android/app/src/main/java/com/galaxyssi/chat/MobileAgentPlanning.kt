        ...
        val manifestAction = connectorAction(
            ...
            parameters = mapOf(
                ...
                "_galaxyssi_desktop_executor_full" to
                    (plannerTarget.desktopAccessProfile == GalaxySSILinkProtocol.ACCESS_DESKTOP_EXECUTOR).toString()
            )
        )
    ...
    internal fun nativeToolAction(request: AgentRequest, toolId: String, input: JSONObject): AgentAction? {
        ...
        return AgentAction(
            ...
            parameters = mapOf(
                ...
                "_galaxyssi_native_tool_location" to descriptor.location.wireValue,
                "_galaxyssi_execution_device_id" to input.optString("desktop_id"),
                "response_language" to configuredResponseLanguageCode(request.goal),
...
internal fun AgentAction.isDesktopNativeTool(): Boolean =
    kind == AgentActionKind.CALL_NATIVE_TOOL &&
        (
            parameters["_galaxyssi_native_tool_location"] == AgentNativeToolLocation.DESKTOP.wireValue ||
...
object AgentRouteResolver {
    fun resolve(action: AgentAction, targets: List<AgentCallableTarget>): AgentRoute {
        ...
        return AgentRoute(
            ...
            executionDeviceId = action.parameters["_galaxyssi_execution_device_id"]
                .orEmpty()
