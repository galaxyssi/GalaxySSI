...
object AgentVisibleCaptureContract {
    const val EXTRA_REQUEST_ID = "galaxyssi.extra.VISIBLE_CAPTURE_REQUEST_ID"
    const val EXTRA_CAMERA_FACING = "galaxyssi.extra.CAMERA_FACING"
    const val EXTRA_MAX_DURATION_SECONDS = "galaxyssi.extra.MAX_DURATION_SECONDS"
}
