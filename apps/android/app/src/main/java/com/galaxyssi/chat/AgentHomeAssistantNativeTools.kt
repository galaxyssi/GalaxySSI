...
class AgentAndroidHomeAssistantToolPlatform(context: Context) : AgentHomeAssistantToolPlatform {
    ...
    override val implementationId: String = "galaxyssi.android.home_assistant_rest"
...
object AgentHomeAssistantNativeTools {
    const val CONNECTION_STATUS = "galaxyssi.home_assistant.connection.status"
    const val ENTITIES_LIST = "galaxyssi.home_assistant.entities.list"
    const val ENTITY_READ = "galaxyssi.home_assistant.entity.read"
    const val SERVICE_CALL = "galaxyssi.home_assistant.service.call"

    const val INTERNET_PERMISSION = Manifest.permission.INTERNET
    const val READ_CONSENT = "galaxyssi.consent.home_assistant_read"
    const val CONTROL_CONSENT = "galaxyssi.consent.home_assistant_control"
    ...
    private const val EXECUTOR_ID = "galaxyssi.android_home_assistant_tools"
