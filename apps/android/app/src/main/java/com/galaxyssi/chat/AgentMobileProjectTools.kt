...
internal class AgentMobileProjectRepository(
    ...
    companion object {
        ...
        private const val DEFAULT_AUTHOR_NAME = "GalaxySSI"
        private const val DEFAULT_AUTHOR_EMAIL = "galaxyssi@hotmail.com"
...
object AgentMobileProjectNativeTools {
    const val CLONE = "galaxyssi.project.repository.clone"
    const val OBSERVE = "galaxyssi.project.repository.observe"
    const val INSPECT = "galaxyssi.project.repository.inspect"
    const val DIFF = "galaxyssi.project.repository.diff"
    const val LOG = "galaxyssi.project.repository.log"
    const val FETCH = "galaxyssi.project.repository.fetch"
    const val CHECKOUT_BRANCH = "galaxyssi.project.repository.branch.checkout"
    const val COMMIT = "galaxyssi.project.repository.commit"
    const val PULL = "galaxyssi.project.repository.pull"
    const val PUSH = "galaxyssi.project.repository.push"
    const val CREATE_PULL_REQUEST = "galaxyssi.project.github.pull_request.create"
    const val PUBLISH_PULL_REQUEST = "galaxyssi.project.github.pull_request.publish"
    const val FINALIZE_PULL_REQUEST = "galaxyssi.project.github.pull_request.finalize"

    const val READ_CONSENT = "galaxyssi.consent.project_read"
    const val WRITE_CONSENT = "galaxyssi.consent.project_write"
    const val PUBLISH_CONSENT = "galaxyssi.consent.project_publish"
        ...
        definition(
            ...
            guarded("project_commit_failed") {
                repository.commit(
                    ...
                    invocation.string("author_name", "GalaxySSI"),
                    invocation.string("author_email", "galaxyssi@hotmail.com")
        ...
        definition(
            ...
            guarded("project_finalize_failed") {
                repository.finalizePullRequest(
                    ...
                    authorName = invocation.string("author_name", "GalaxySSI"),
                    authorEmail = invocation.string("author_email", "galaxyssi@hotmail.com"),
    ...
    private fun definition(
        ...
        descriptor = AgentNativeToolDescriptor(
            ...
            requiredPermissions = listOf(
                AgentNativePermissionRequirement(
                    ...
                    "Limits repository access to the current GalaxySSI conversation project"
                )
            ),
        ...
        executorId = "galaxyssi.android_project_repository",
