...
class SharedPreferencesAgentSessionStore internal constructor(
    ...
    internal fun decodeScreen(json: JSONObject?): ScreenContext {
        if (json == null) return ScreenContext(foregroundApp = "GalaxySSI", pageTitle = "Agent")
        return ScreenContext(
            foregroundApp = json.optString("foreground_app", "GalaxySSI"),
    ...
    companion object {
        internal const val PREFS = "galaxyssi_agent_runtime"
