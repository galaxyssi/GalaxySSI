...
class AgentAndroidVisibleCapturePlatform(context: Context) : AgentVisibleCapturePlatform {
    ...
    override val implementationId: String = "galaxyssi.android.visible_capture"
    ...
    override fun availability(kind: AgentVisibleCaptureKind): AgentNativeToolAvailability {
        ...
        return when {
            ...
            !isAppVisible() -> AgentNativeToolAvailability(
                AgentNativeToolAvailabilityStatus.REQUIRES_SETUP,
                "User-visible capture requires GalaxySSI to be in the foreground"
            )
...
object AgentVisibleCaptureNativeTools {
    const val CAMERA_CAPTURE = "galaxyssi.camera.capture.visible"
    const val MICROPHONE_RECORD = "galaxyssi.microphone.record.visible"

    const val CAMERA_PERMISSION = Manifest.permission.CAMERA
    const val MICROPHONE_PERMISSION = Manifest.permission.RECORD_AUDIO
    const val RUNTIME_PERMISSION_CONSENT = "galaxyssi.consent.runtime_permission_dialog"
    const val USER_VISIBLE_CAPTURE_CONSENT = "galaxyssi.consent.user_visible_capture"
    ...
    private const val EXECUTOR_ID = "galaxyssi.android_visible_capture"
