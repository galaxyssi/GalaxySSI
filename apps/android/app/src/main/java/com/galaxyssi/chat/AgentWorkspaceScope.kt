...
object AgentWorkspaceScope {
    fun id(conversationId: String, sessionId: String = ""): String {
        ...
        return UUID.nameUUIDFromBytes("galaxyssi-workspace:$owner".toByteArray(Charsets.UTF_8)).toString()
    }
    ...
    private val WORKSPACE_TOOL_PREFIXES = listOf("galaxyssi.workspace.", "galaxyssi.project.")
