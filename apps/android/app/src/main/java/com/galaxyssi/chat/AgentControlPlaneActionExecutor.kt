...
class AgentControlPlaneActionExecutor private constructor(
    ...
    companion object {
        private const val CONVERSATION_ID_KEY = "_galaxyssi_conversation_id"
        private const val TURN_ID_KEY = "_galaxyssi_turn_id"
...
internal class ActionExecutorAgentProvider(
    ...
    override val providerId: String = "galaxyssi-connectors",
    ...
    override suspend fun sendMessage(runId: String, message: AgentControlMessage) {
        ...
        val followUpAction = active.action.copy(
            ...
            parameters = active.action.parameters + mapOf(
                ...
                "_galaxyssi_turn_id" to message.messageId,
