...
object AgentEvalBenchmarkCatalog {
    val standard: AgentBenchmarkSuite by lazy {
        AgentBenchmarkSuite(
            id = "galaxyssi-android-real-agent",
            version = "1.2.0",
            title = "GalaxySSI Android Real Agent EvalOps",
    ...
    val longitudinalMemory: AgentBenchmarkSuite by lazy {
        AgentBenchmarkSuite(
            id = "galaxyssi-android-longitudinal-memory",
            version = "1.0.0",
            title = "GalaxySSI Android 30/90-day Memory Certification",
    ...
    private fun planningCases() = listOf(
        ...
        planning("plan-tool-02", "应用版本核验", "先规划，再使用工具读取当前 GalaxySSI 的版本名称和版本号，最后报告证据。"),
    ...
    private fun androidWorldCases() = listOf(
        world("android-world-01", "前台应用", "确认 GalaxySSI 当前位于前台，并报告其包名。"),
