            ...
            sections = listOf(
                ControlCenterSectionSpec(
                    ...
                    listOf(
                        ...
                        ControlCenterRowSpec("profile.copy_id", getString(R.string.settings_galaxyssi_id), GalaxySSICrypto.localGalaxySSIId(), R.drawable.ic_protocol_link, getString(R.string.common_copy), ControlCenterTone.NEUTRAL, showChevron = false)
                    )
                ),
                ControlCenterSectionSpec(
...
internal fun MainActivity.renderControlCenterPermissionsPage() {
    val accessibility = GalaxySSIAccessibilityService.isActive()
    val notificationAccess = GalaxySSINotificationListenerService.currentContext().hasAccess
