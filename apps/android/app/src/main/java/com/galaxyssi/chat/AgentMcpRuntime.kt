...
class AgentMcpStreamableHttpTransport(
    ...
    override suspend fun send(message: String) = withContext(Dispatchers.IO) {
        ...
        val request = Request.Builder()
            ...
            .header("User-Agent", "GalaxySSI-Android-MCP/1")
            .apply {
...
object AgentMcpNativeTools {
    const val LIST_CONNECTIONS = "galaxyssi.mcp.connections.list"
    const val LIST_TOOLS = "galaxyssi.mcp.tools.list"
    const val CALL_TOOL = "galaxyssi.mcp.tool.call"
