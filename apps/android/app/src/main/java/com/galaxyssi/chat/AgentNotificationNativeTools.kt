...
class AgentAndroidNotificationToolPlatform(context: Context) : AgentNotificationToolPlatform {
    ...
    override val implementationId: String = "galaxyssi.android.notification_listener"

    override fun availability(): AgentNativeToolAvailability {
        val notificationContext = GalaxySSINotificationListenerService.currentContext(MAX_NOTIFICATIONS)
    ...
    override fun snapshot(limit: Int): AgentNotificationContext =
        GalaxySSINotificationListenerService.currentContext(limit)

    override fun reply(notificationKey: String, text: String): AgentNotificationReplyResult =
        GalaxySSINotificationListenerService.reply(notificationKey, text)
...
object AgentNotificationNativeTools {
    const val NOTIFICATIONS_LIST = "galaxyssi.notifications.list"
    const val NOTIFICATION_REPLY = "galaxyssi.notifications.reply"
    ...
    const val READ_CONSENT = "galaxyssi.consent.notification_read"
    const val REPLY_CONSENT = "galaxyssi.consent.sensitive_action_confirmation"
    ...
    private fun descriptor(
        ...
        requiredPermissions = listOf(
            ...
            AgentNativePermissionRequirement(
                ...
                "Notification access",
                "The user must enable GalaxySSI in Android notification access settings."
            )
        ),
    ...
    private const val EXECUTOR_ID = "galaxyssi.android_notification_tools"
