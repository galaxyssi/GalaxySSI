...
object AndroidCognitionScheduler {
    ...
    private const val EVENT_WORK = "signalasi-cognition-event-v1"
    private const val SCHEDULED_WORK = "signalasi-cognition-scheduled-v1"
    private const val EXPLICIT_WORK = "signalasi-cognition-explicit-v1"
    private const val PROJECTION_WORK = "signalasi-obsidian-projection-v1"
    private const val WORK_TAG = "signalasi-cognition"
}
...
object AndroidCognitionNotificationCenter {
    ...
    private const val CHANNEL_ID = "signalasi_cognition"
    ...
    fun notify(context: Context, candidate: GlobalAgentNotificationCandidate): Boolean = runCatching {
        ...
        val openIntent = Intent(context, MainActivity::class.java).apply {
            ...
            putExtra("signalasi_agent_conversation_id", candidate.conversationId)
        }
