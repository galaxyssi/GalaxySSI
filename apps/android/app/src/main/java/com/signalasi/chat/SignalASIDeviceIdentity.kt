...
internal data class SignalASILocalDeviceProfile(
    val deviceId: String,
...
internal object SignalASIDeviceIdentity {
    fun current(context: Context, profile: JSONObject, fingerprint: String): SignalASILocalDeviceProfile {
