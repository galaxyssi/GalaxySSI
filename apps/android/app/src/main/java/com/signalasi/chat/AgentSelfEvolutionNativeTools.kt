...
object AgentSelfEvolutionNativeTools {
    const val STATUS = "signalasi.evolution.status"
    const val LIST = "signalasi.evolution.tasks.list"
    const val CREATE = "signalasi.evolution.tasks.create"
    const val PREPARE = "signalasi.evolution.candidate.prepare"
    const val APPLY_PATCH = "signalasi.evolution.candidate.patch"
    const val ROLLBACK = "signalasi.evolution.candidate.rollback"
    const val CONSENT = "signalasi.consent.self_evolution"
    ...
    private fun definition(
        ...
        return AgentNativeToolDefinition(
            ...
            executorId = "signalasi.android_self_evolution",
