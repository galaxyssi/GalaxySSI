...
import com.signalasi.chat.MainActivity
...
class LargeTurboQnnModelDownloadService : Service() {
        ...
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentIntent(PendingIntent.getActivity(
                ...
                Intent(this, MainActivity::class.java)
                    .putExtra("signalasi_debug_open_local_model", true),
    ...
    companion object {
        private const val ACTION_START = "com.signalasi.chat.qnn.large_turbo.START"
        private const val ACTION_PAUSE = "com.signalasi.chat.qnn.large_turbo.PAUSE"
        private const val EXTRA_NETWORK_POLICY = "network_policy"
        private const val CHANNEL_ID = "signalasi_qnn_large_turbo"
