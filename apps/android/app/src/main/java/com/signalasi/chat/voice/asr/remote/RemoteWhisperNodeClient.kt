...
import com.signalasi.chat.SignalASIMqttClient
...
object SignalASILinkRemoteWhisperTransport : RemoteWhisperTransport {
    override fun publish(desktopId: String, payload: JSONObject): Boolean =
        SignalASIMqttClient.publishRemoteWhisperPacket(desktopId, payload)
}
