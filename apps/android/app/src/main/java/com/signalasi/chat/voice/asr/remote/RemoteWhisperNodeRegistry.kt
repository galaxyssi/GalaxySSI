package com.signalasi.chat.voice.asr.remote

import android.content.Context
import com.signalasi.chat.AgentEncryptedPreferences
import com.signalasi.chat.SignalASILinkProtocol
import org.json.JSONObject

object RemoteWhisperNodeRegistry {
    private const val PREFERENCES = "signalasi_remote_whisper_nodes"
    ...
    private fun decode(value: JSONObject?): RemoteWhisperNodeCapability? {
        ...
        return runCatching {
            ...
            RemoteWhisperNodeCapability(
                ...
                desktopName = value.optString("desktop_name", "SignalASI Desktop"),
