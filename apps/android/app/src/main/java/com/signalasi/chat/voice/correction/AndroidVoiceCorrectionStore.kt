package com.signalasi.chat.voice.correction
...
class AndroidVoiceExecutionRecordStore(context: Context) : VoiceExecutionRecordPersistence {
    ...
    private companion object {
        const val EXECUTION_PREFERENCES = "signalasi_voice_execution_v1"
...
class VoiceCorrectionJournal(context: Context) {
    ...
    private companion object {
        const val CORRECTION_PREFERENCES = "signalasi_voice_corrections_v1"
