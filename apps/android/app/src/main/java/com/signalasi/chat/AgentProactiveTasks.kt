...
const val AGENT_PROACTIVE_PROTOCOL = "signalasi.proactive-task.v1"
...
class AgentRemoteProactiveEventStore(context: Context) {
    ...
    private companion object {
        const val DATABASE = "signalasi_remote_proactive_events_v1"
...
class AgentProactiveTaskStore(context: Context) {
    ...
    private companion object {
        const val DATABASE = "signalasi_proactive_tasks_v1"
...
object AgentProactiveTaskScheduler {
    const val ACTION_RUN = "com.signalasi.chat.action.RUN_PROACTIVE_TASK"
    ...
    fun acceptRemoteWebhook(
        ...
        val trusted = SignalASILinkProtocol.allServerLinks(context).any {
...
object AgentProactiveTaskExecutor {
    ...
    private fun goalCheckpointPrompt(task: AgentProactiveTask, prompt: String): String {
        ...
        return buildString {
            ...
            append("SIGNALASI_GOAL_STATUS: complete, continue, or blocked.")
        }
    }
    ...
    private fun goalState(value: String): String {
        ...
        return listOf("complete", "continue", "blocked").firstOrNull {
            "signalasi_goal_status: $it" in lowered
        } ?: "continue"
    }

    private fun stripGoalState(value: String): String = value.lineSequence()
        .filterNot { it.trim().startsWith("SIGNALASI_GOAL_STATUS:", ignoreCase = true) }
        .joinToString("\n")
        .trim()
...
private object AgentProactiveTaskNotifier {
    private const val CHANNEL_ID = "signalasi.proactive.tasks"
