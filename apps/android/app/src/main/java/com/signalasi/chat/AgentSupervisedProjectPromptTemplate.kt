...
internal object AgentSupervisedProjectPromptTemplate {
    ...
    private fun StringBuilder.appendCompactContinuationContract() {
        ...
        append("Batch reads; search large files; use start_line/max_lines. Reuse known_sha256 for identical ranges to omit unchanged text. Install evidenced dependencies; change failed approaches; use task-aware watchdogs. ")
    ...
    private fun StringBuilder.appendInitialPlanningContract() {
        ...
        append("Batch reads; search large files; use start_line/max_lines. Reuse known_sha256 for identical ranges to omit unchanged text. Change failed approaches; use task-aware timeouts. test/build/lint/package requires host receipt. ")
