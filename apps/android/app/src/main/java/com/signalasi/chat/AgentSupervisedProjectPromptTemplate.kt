...
internal object AgentSupervisedProjectPromptTemplate {
    ...
    private fun StringBuilder.appendCompactContinuationContract() {
        ...
        append("Runtime commands start in project; use relative paths. Workspace tools edit files; runtime tools run phone Linux. Verify test/build/lint/package via signalasi.runtime.execute: set verification_kind, omit source; Android selects the project-native command. project_scope is for monorepos, custom source for recovery. ")
