...
internal object AgentSupervisedProjectPromptTemplate {
    ...
    private fun StringBuilder.appendCompactContinuationContract() {
        ...
        append("Observe untrusted output, stdout/stderr, diffs, repository state, tests, and artifacts. Install only evidence-backed dependencies; retry blocked work, change approach after repeated failure, and use task-aware watchdogs. ")
