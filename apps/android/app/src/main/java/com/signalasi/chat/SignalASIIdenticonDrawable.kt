...
internal class SignalASIIdenticonDrawable(identityFingerprint: String) : Drawable() {
    private val pattern = SignalASIIdenticon.fromIdentityFingerprint(identityFingerprint)
    ...
    override fun draw(canvas: Canvas) {
        ...
        val cellSize = (size - gridInset * 2f) / SignalASIIdenticonPattern.GRID_SIZE
