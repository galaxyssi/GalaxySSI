...
internal class PeerFileAttachmentView(context: Context) : FrameLayout(context) {
    private val fileIcon = ImageView(context).apply {
        ...
        imageTintList = ColorStateList.valueOf(context.getColor(R.color.signalasi_blue))
...
private class PeerTransferProgressRingView(context: Context) : View(context) {
    ...
    private val arc = Paint(track).apply { color = context.getColor(R.color.signalasi_blue) }
    private val label = Paint(Paint.ANTI_ALIAS_FLAG).apply {
        color = context.getColor(R.color.signalasi_blue)
