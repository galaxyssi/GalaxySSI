...
object AgentWebIntelligenceNativeTools {
    const val SEARCH = "signalasi.web.intelligence.search"
    const val FETCH = "signalasi.web.intelligence.fetch"
    const val CRAWL = "signalasi.web.intelligence.crawl"
    const val EXTRACT = "signalasi.web.intelligence.extract"
    const val CACHE = "signalasi.web.intelligence.cache"
    const val FIND_SIMILAR = "signalasi.web.intelligence.find_similar"
    const val RESEARCH = "signalasi.web.intelligence.research"
    const val AGENT = "signalasi.web.intelligence.agent"
    const val DIFF = "signalasi.web.intelligence.diff"
    const val WATCH = "signalasi.web.intelligence.watch"

    private const val VERSION = "1.0.0"
    private const val EXECUTOR_ID = "signalasi.android.web_intelligence"
    ...
    fun definitions(
        ...
        definition(
            ...
            "Inspects, searches or clears SignalASI's encrypted local web document and search cache.",
            cacheSchema(),
            60_000L,
            service,
            availability,
    ...
    private fun definition(
            ...
            try {
                ...
                AgentNativeToolExecutionResult.success(
                    ...
                    metadata = mapOf(
                        ...
                        "implementation" to "signalasi_native_android",
        ...
        provenanceMetadata = mapOf(
            "implementation" to "clean_room_signalasi",
