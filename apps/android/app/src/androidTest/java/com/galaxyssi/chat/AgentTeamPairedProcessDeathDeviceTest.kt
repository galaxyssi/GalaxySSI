...
class AgentTeamPairedProcessDeathDeviceTest {
    ...
    private companion object {
        const val PHASE_ARGUMENT = "galaxyssi_phase"
        const val FORCED_AT_ARGUMENT = "galaxyssi_forced_at"
        const val PHASE_SEED = "seed"
        const val PHASE_RECOVER = "recover"
        const val CODEX_AGENT_ID = "codex"
        const val ACCEPTANCE_MARKER = "GALAXYSSI_PAIRED_TEAM_ACCEPTANCE"
        ...
        const val ACCEPTANCE_PREFERENCES = "galaxyssi_paired_team_process_death_acceptance"
