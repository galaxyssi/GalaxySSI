...
class AgentRichContentRenderingTest {
    ...
    private fun showcaseBlocks(): List<AgentRichBlock> = listOf(
        ...
        AgentRichBlock("image", AgentRichBlockType.IMAGE, title = "Generated image", uri = "android.resource://com.galaxyssi.chat/drawable/galaxyssi_mark", text = "Tap to inspect the full-resolution result."),
        AgentRichBlock("gallery", AgentRichBlockType.GALLERY, title = "Image set", rows = listOf(
            listOf("android.resource://com.galaxyssi.chat/drawable/galaxyssi_mark", "GalaxySSI", "image/png"),
            listOf("android.resource://com.galaxyssi.chat/drawable/logo_codex_product", "Codex", "image/png")
        )),
