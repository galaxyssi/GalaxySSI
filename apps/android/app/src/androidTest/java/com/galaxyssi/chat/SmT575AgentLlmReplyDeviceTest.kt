...
class SmT575AgentLlmReplyDeviceTest {
    ...
    fun receivesOneRealCodexReply() {
        ...
        val goal = """
            This is a real GalaxySSI Agent transport acceptance case on SM-T575.
    ...
    private fun promptFor(testCase: RealLlmCase): String = """
        GalaxySSI SM-T575 language-model response check ${testCase.index} of $EXPECTED_CASE_COUNT.
