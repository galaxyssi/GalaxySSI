...
class AgentDesktopArtifactCardRenderingTest {
    ...
    fun rendersCodexStyleImageAndDownloadableFileCards() {
        ...
        val items = listOf(
            ...
            StoredFixture("report.txt", "text/plain", "SignalASI result\nVerified".toByteArray(), AgentRichBlockType.FILE),
            StoredFixture(
                "SnakeGame.apk",
        ...
        val blocks = items.mapIndexed { index, fixture ->
            val artifactUri = "signalasi-artifact://showcase/outputs/${fixture.name}"
        ...
        val screenshotUri = context.contentResolver.insert(
            ...
            ContentValues().apply {
                put(MediaStore.Images.Media.DISPLAY_NAME, "signalasi-artifact-card-showcase.png")
                put(MediaStore.Images.Media.MIME_TYPE, "image/png")
                put(
                    MediaStore.Images.Media.RELATIVE_PATH,
                    Environment.DIRECTORY_PICTURES + "/SignalASI-tests"
                )
            }
