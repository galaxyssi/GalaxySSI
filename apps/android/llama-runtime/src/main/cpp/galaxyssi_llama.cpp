...
namespace {
constexpr const char * LOG_TAG = "GalaxySSILlama";
...
Java_com_galaxyssi_llama_GalaxySSILlamaRuntime_nativeInitialize(
    JNIEnv * env,
    jobject,
...
Java_com_galaxyssi_llama_GalaxySSILlamaRuntime_nativeLoadModel(
    JNIEnv * env,
    jobject,
...
Java_com_galaxyssi_llama_GalaxySSILlamaRuntime_nativeGenerate(
    JNIEnv * env,
    jobject,
...
extern "C" JNIEXPORT void JNICALL
Java_com_galaxyssi_llama_GalaxySSILlamaRuntime_nativeUnload(JNIEnv *, jobject) {
    std::lock_guard<std::mutex> guard(runtime_mutex);
    unload_locked();
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_galaxyssi_llama_GalaxySSILlamaRuntime_nativeSystemInfo(JNIEnv * env, jobject) {
    std::lock_guard<std::mutex> guard(runtime_mutex);
    return utf8_string(env, backend_initialized ? llama_print_system_info() : "");
}

extern "C" JNIEXPORT jstring JNICALL
Java_com_galaxyssi_llama_GalaxySSILlamaRuntime_nativeBackendInfo(JNIEnv * env, jobject) {
    std::lock_guard<std::mutex> guard(runtime_mutex);
    return utf8_string(env, backend_names());
}

extern "C" JNIEXPORT jboolean JNICALL
Java_com_galaxyssi_llama_GalaxySSILlamaRuntime_nativeOsExposesSme(JNIEnv *, jobject) {
