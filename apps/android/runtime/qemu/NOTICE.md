# GalaxySSI Android QEMU Runtime Notice

The optional GalaxySSI Android Linux runtime launches an unmodified-device, no-root QEMU system
...
GalaxySSI does not require the Termux application and does not execute a Termux userspace. The
