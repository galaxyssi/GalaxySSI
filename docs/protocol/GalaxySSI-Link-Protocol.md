...
GalaxySSI Link Protocol v2 is the only supported public-relay protocol. It is a
...
The Desktop exposes a compact QR at `/galaxyssi/verify`. Android normalizes and
