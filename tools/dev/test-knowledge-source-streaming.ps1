param(
    ...
    [string]$OutputDirectory = 'build/knowledge-source-streaming-runs'
)
...
$classes = @('KnowledgeSourceReplaceDeviceTest', 'KnowledgeSourceStagingDeviceTest',
    'KnowledgeSourceReplaceScaleDeviceTest', 'AgentKnowledgeDatabaseDeviceTest', 'KnowledgeIdentityDeviceTest',
    'KnowledgeSourcePagingDeviceTest', 'KnowledgeSearchSnapshotDeviceTest', 'AgentKnowledgeFtsDeviceTest',
    'KnowledgeHybridSearchDeviceTest', 'KnowledgeRetrievalAdmissionDeviceTest', 'KnowledgePayloadCompactionDeviceTest',
    'KnowledgePayloadUsageDeviceTest', 'KnowledgePayloadDeviceTest', 'KnowledgeSourceSnapshotDeviceTest', 'KnowledgeBackupDeviceTest')
$selection = ($classes | ForEach-Object { "com.galaxyssi.chat.$_" }) -join ','
Write-Output "Running source streaming regressions on $Serial. Evidence: $directory"
...
if ($exitCode -ne 0 -or $passed -ne 106 -or $failures -ne 0 -or $truncated -or !($lines -contains 'OK (106 tests)')) {
...
Write-Output "Verified 106 device cases. Evidence: $directory"
